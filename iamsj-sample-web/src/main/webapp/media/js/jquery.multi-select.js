    ...
    init: function(){
      ...
      if (ms.next('.ms-container').length === 0){
        ...
        ms.find('optgroup, option').each(function(){
          if ($(this).is('optgroup')){
            optgroupLabel = '<li class="ms-optgroup-label" id='+$(this).attr('id')+'><span>'+$(this).attr('label')+'</span></li>';
            ...
            var optgroup = $(this),
                ...
                optgroupSelectionLi = $(optgroupLabel),
                optgroupSelectableLi = $(optgroupLabel);
